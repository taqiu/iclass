			...
			<div class="container">
				...
				<div class="nav-collapse">
					...
					<ul class="nav pull-right">
						 <li class="dropdown">
							<a id="user-panel" href="#" class="dropdown-toggle" data-toggle="dropdown"><span <?php if (Yii::app()->user->getRole()==='admin') echo 'id="content_right_head"'; else if (Yii::app()->user->getRole()==='labMember') echo 'id="content_right_head2"';?>><i class="icon-user icon-white"></i> <?php echo Yii::app()->user->name ?></span><b class="caret"></b></a>
