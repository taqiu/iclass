...
class MultiModelForm extends CWidget
{
     ...
     */
    public $addItemText = 'Add Possible Answer';
     ...
     * @var string $removeText
     */
    public $removeConfirm = 'Delete this answer?';
     ...
     */
    public $removeHtmlOptions = array('class'=>'btn btn-primary');
...
class MultiModelRenderForm extends CForm
{
    ...
    public function renderButtons()
    {
        if ($this->parentWidget->bootstrapLayout)
        {
            ...
            return $output !== '' ? "<div class=\"btn btn-primary\">" . $output . "</div>\n" : '';
        } else
