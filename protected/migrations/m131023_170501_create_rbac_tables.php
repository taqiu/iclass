...
class m131023_170501_create_rbac_tables extends CDbMigration
{
	public function up()
	{
		...
		$this->addForeignKey(
			'fk_auth_item_child_parent',      // $name
			'{{auth_item_child}}',            // $table
			'parent',                         // $columns
			'{{auth_item}}',                  // $refTable
			'name',                           // $refColumns
			'CASCADE',                        // $delete  the ON DELETE option
			'CASCADE'                         // $update  the ON UPDATE option
		);
